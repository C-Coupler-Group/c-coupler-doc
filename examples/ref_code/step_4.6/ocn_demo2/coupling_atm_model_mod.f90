module coupling_atm_model_mod
    ...
    integer, public             :: ocn_demo2_comp_id
    integer, private            :: decomp_id, grid_h2d_id
    
contains

    subroutine register_ocn_demo2_component(comm)
        use CCPL_interface_mod
        integer, intent(inout) :: comm
        ocn_demo2_comp_id = CCPL_register_component(-1, "ocn_demo2", "ocn", comm, change_dir=.true., annotation = "register ocn model ocn_demo2")
    end subroutine register_ocn_demo2_component
    ...
    subroutine register_component_coupling_configuration
        ...
        call CCPL_set_normal_time_step(ocn_demo2_comp_id, time_step, annotation="setting the time step for ocn_demo2")

        grid_h2d_id = CCPL_register_H2D_grid_via_global_data(ocn_demo2_comp_id, "ocn_demo2_H2D_grid", "LON_LAT", "degrees", "cyclic", lonlen, latlen, 0.0, 360.0, -90.0, 90.0, lon, lat, mask, annotation="register ocn_demo2 H2D grid ")
        decomp_id = CCPL_register_normal_parallel_decomp("decomp_ocn_demo2_grid", grid_H2D_id, decomp_size, local_grid_cell_index(:,mytask_id+1), annotation="allocate decomp for ocn_demo2 grid")
        ...
        timer_id = CCPL_define_single_timer(ocn_demo2_comp_id, "seconds", coupling_freq, 0, 0, annotation="define a single timer for ocn_demo2")
        ...
        call CCPL_end_coupling_configuration(ocn_demo2_comp_id, annotation = "component ocn_demo2 ends configuration")
