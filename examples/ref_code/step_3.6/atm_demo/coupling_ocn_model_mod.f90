...
contains
    ...
    subroutine register_component_coupling_configuration
        ...
        field_id_prect = CCPL_register_field_instance(prectm, "prect", decomp_id, grid_h2d_id, 0, usage_tag=CCPL_TAG_CPL_REST, field_unit="K", annotation="register field instance of Surface temperature")
