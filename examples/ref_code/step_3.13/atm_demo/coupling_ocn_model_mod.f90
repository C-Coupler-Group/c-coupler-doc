...
contains
    ...
    subroutine register_component_coupling_configuration
        ...
        grid_h2d_id2 = CCPL_register_H2D_grid_via_global_data(atm_demo_comp_id, "atm_demo_H2D_grid2", "LON_LAT", "degrees", "cyclic", lonlen, latlen, 0.0, 360.0, -90.0, 90.0, lon, lat, maskm, annotation="register atm_demo H2D grid2 ")
        ...
        decomp_id2 = CCPL_register_normal_parallel_decomp("decomp_atm_demo_grid2", grid_H2D_id2, decomp_size, local_grid_cell_index(:,mytask_id+1), annotation="allocate decomp for atm_demo grid2")
        ...
        field_id_sst  = CCPL_register_field_instance(sst, "sst", decomp_id2, grid_h2d_id2, 0, usage_tag=CCPL_TAG_CPL_REST, field_unit="C", annotation="register field instance of Sea surface temperature")
        field_id_shf  = CCPL_register_field_instance(shf, "shf", decomp_id2, grid_h2d_id2, 0, usage_tag=CCPL_TAG_CPL_REST, field_unit="W/m2", annotation="register field instance of Net surface heat flux")
        field_id_ssh = CCPL_register_field_instance(ssh, "ssh", decomp_id2, grid_h2d_id2, 0, usage_tag=CCPL_TAG_CPL_REST, field_unit="m", annotation="register field instance of Sea surface height")
        field_id_mld = CCPL_register_field_instance(mld, "mld", decomp_id2, grid_h2d_id2, 0, usage_tag=CCPL_TAG_CPL_REST, field_unit="m", annotation="register field instance of Mixed layer depth")
